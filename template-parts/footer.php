...
<footer class="wp-block-group is-style-section-1 has-contrast-color has-base-background-color has-text-color has-background has-link-color" style="border-top-width:2px;border-bottom-width:2px;margin-top:0;margin-bottom:0;padding-top:var(--wp--preset--spacing--70);padding-right:var(--wp--preset--spacing--50);padding-bottom:var(--wp--preset--spacing--70);padding-left:var(--wp--preset--spacing--50)">
    ...
    <?php
    $official_links = '
    <!-- wp:social-links {"iconColor":"base","iconColorValue":"#f4eee1","iconBackgroundColor":{"color":"#182949","name":"Accent 3","slug":"accent-3","class":"has-accent-3-icon-background-color"},"iconBackgroundColorValue":"#182949","openInNewTab":true,"className":"is-style-default","layout":{"type":"flex","justifyContent":"center"}} -->
    ...
    <!-- /wp:social-links -->';
    $unofficial_links = '
    <!-- wp:social-links {"iconColor":"base","iconColorValue":"#f4eee1","iconBackgroundColor":"accent-3","iconBackgroundColorValue":"#182949","layout":{"type":"flex","justifyContent":"center","flexWrap":"wrap"}} -->
